...
test("ACCEPTED cases: accepts valid .ts file with exports issue type", () => {
...
test("ACCEPTED cases: accepts valid .tsx file with exports issue type", () => {
  expect(isAcceptedFinding(baseFinding)).toBe(true);
});

test("ACCEPTED cases: accepts files issue type", () => {
  const finding: Finding = { ...baseFinding, issueType: "files" };
  expect(isAcceptedFinding(finding)).toBe(true);
});

test("ACCEPTED cases: accepts exports issue type", () => {
  const finding: Finding = { ...baseFinding, issueType: "exports" };
  expect(isAcceptedFinding(finding)).toBe(true);
});

test("ACCEPTED cases: accepts types issue type", () => {
  const finding: Finding = { ...baseFinding, issueType: "types" };
  expect(isAcceptedFinding(finding)).toBe(true);
});

test("ACCEPTED cases: accepts enumMembers issue type", () => {
  const finding: Finding = { ...baseFinding, issueType: "enumMembers" };
  expect(isAcceptedFinding(finding)).toBe(true);
});

test("ACCEPTED cases: accepts deep nested paths under src/", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("ACCEPTED cases: accepts production fixture files", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("ACCEPTED cases: accepts production mock files", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("REJECTED cases - path does not start with src/: rejects packages/ path", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("REJECTED cases - path does not start with src/: rejects lib/ path", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("REJECTED cases - path does not start with src/: rejects root level path", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("REJECTED cases - path does not start with src/: rejects src without trailing slash", () => {
  const finding: Finding = {
    ...baseFinding,
    normalizedPath: "src",
    filePath: "src",
...
test("REJECTED cases - file extension: rejects .js files", () => {
  const finding: Finding = {
    ...baseFinding,
    fileExtension: "js",
...
test("REJECTED cases - file extension: rejects .jsx files", () => {
  const finding: Finding = {
    ...baseFinding,
    fileExtension: "jsx",
...
test("REJECTED cases - file extension: rejects .d.ts files", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("REJECTED cases - filename patterns: rejects .test. in filename", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("REJECTED cases - filename patterns: rejects .spec. in filename", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("REJECTED cases - filename patterns: rejects .stories. in filename", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("REJECTED cases - filename patterns: rejects .story. in filename", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("REJECTED cases - filename patterns: rejects .testHelpers. in filename", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("REJECTED cases - issue type: rejects classMembers issue type", () => {
  const finding: Finding = { ...baseFinding, issueType: "classMembers" };
  expect(isAcceptedFinding(finding)).toBe(false);
});

test("REJECTED cases - issue type: rejects duplicates issue type", () => {
  const finding: Finding = { ...baseFinding, issueType: "duplicates" };
  expect(isAcceptedFinding(finding)).toBe(false);
});

test("REJECTED cases - issue type: rejects unknown issue type", () => {
  const finding: Finding = { ...baseFinding, issueType: "unknown" };
  expect(isAcceptedFinding(finding)).toBe(false);
});

test("REJECTED cases - directory segments: rejects 'test' directory segment", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("REJECTED cases - directory segments: rejects 'tests' directory segment", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("REJECTED cases - directory segments: rejects '__tests__' directory segment", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("REJECTED cases - directory segments: rejects 'stories' directory segment", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("REJECTED cases - directory segments: rejects '__stories__' directory segment", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("REJECTED cases - directory segments: rejects 'story' directory segment", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("REJECTED cases - directory segments: rejects multiple directory segments with 'test'", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("Edge cases: rejects when multiple rejection conditions apply", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("Edge cases: handles complex paths with segments", () => {
  const finding: Finding = {
    ...baseFinding,
    normalizedPath:
      "src/dashboard/components/nativeFilters/ConfigModal/ModalFooter.tsx",
    filePath:
      "src/dashboard/components/nativeFilters/ConfigModal/ModalFooter.tsx",
...
test("Edge cases: rejects if segment appears anywhere in path", () => {
  const finding: Finding = {
    ...baseFinding,
...
test("ACCEPTED - actual production code from Knip findings: accepts src/components/Datasource/components/DatasourceEditor/components/index.ts", () => {
  const finding: Finding = {
    normalizedPath:
...
test("ACCEPTED - actual production code from Knip findings: accepts src/dashboard/components/ColorSchemeControlWrapper.tsx", () => {
  const finding: Finding = {
...
test("ACCEPTED - actual production code from Knip findings: accepts src/explore/components/controls/MetricControl/columnType.ts", () => {
  const finding: Finding = {
    normalizedPath:
      "src/explore/components/controls/MetricControl/columnType.ts",
    fileExtension: "ts",
...
test("ACCEPTED - actual production code from Knip findings: accepts src/types/Action.ts", () => {
  const finding: Finding = {
...
test("ACCEPTED - actual production code from Knip findings: accepts src/components/AlteredSliceTag/AlteredSliceTagMocks.ts (prod scan)", () => {
  const finding: Finding = {
...
test("ACCEPTED - actual production code from Knip findings: accepts src/dashboard/components/nativeFilters/FiltersConfigModal/FilterConfigurePane.tsx", () => {
  const finding: Finding = {
    normalizedPath:
      "src/dashboard/components/nativeFilters/FiltersConfigModal/FilterConfigurePane.tsx",
    fileExtension: "tsx",
    filePath:
      "src/dashboard/components/nativeFilters/FiltersConfigModal/FilterConfigurePane.tsx",
...
test("ACCEPTED - actual production code from Knip findings: accepts src/utils/reducerUtils.ts", () => {
  const finding: Finding = {
...
test("ACCEPTED - actual production code from Knip findings: rejects src/features/datasets/metadataBar/DatasetMetadataBar.skipped-stories.tsx (contains -stories.)", () => {
  const finding: Finding = {
    normalizedPath:
      "src/features/datasets/metadataBar/DatasetMetadataBar.skipped-stories.tsx",
    fileExtension: "tsx",
    filePath:
      "src/features/datasets/metadataBar/DatasetMetadataBar.skipped-stories.tsx",
...
test("ACCEPTED - actual production code from Knip findings: rejects src/pages/ChartList/ChartList.testHelpers.tsx (contains .testHelpers.)", () => {
  const finding: Finding = {
...
test("REJECTED - non-src paths from Knip findings: rejects .storybook/shared/createQueryStory.tsx", () => {
  const finding: Finding = {
...
test("REJECTED - non-src paths from Knip findings: rejects .storybook/shared/dummyDatasource.ts", () => {
  const finding: Finding = {
...
test("REJECTED - non-src paths from Knip findings: rejects .storybook/shared/ErrorMessage.tsx", () => {
  const finding: Finding = {
